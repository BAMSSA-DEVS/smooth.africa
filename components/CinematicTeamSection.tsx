...
export const CinematicTeamSection: React.FC = () => {
  ...
  // Initial Text Opacity (Eyebrow, Paragraph)
  // 0-20%: 1
  // 20-30%: 1 -> 0
  ...
  // Stage 5 Transition Out
  const imageOpacity = useTransform(scrollYProgress, [0.85, 0.95], [1, 0]);

  // Bridge text: "From conversations to products."
  ...
  // Render static fallback for reduced motion users
